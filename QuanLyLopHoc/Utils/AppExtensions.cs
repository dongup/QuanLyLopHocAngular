...
namespace QuanLyLopHoc.Utils
{
    public static class AppExtensions
    {
        ...
        /// <returns></returns>
        public static DateTime ToDateTime(this string date, string format = "HH:mm dd/MM/yyyy")
        {

            DateTime now = DateTime.Now;
            if (!string.IsNullOrEmpty(date))
            {
                if (DateTime.TryParseExact(date, format, null, DateTimeStyles.None, out DateTime dOutDate))
                {
                    return dOutDate;
                }
                else
        ...
        /// <param name="culture"></param>
        /// <returns></returns>
        public static DateTime ToDateTimeExactRevert(this string date)
        {
            DateTime now = DateTime.Now;
            if (!string.IsNullOrEmpty(date))
            {
                if (DateTime.TryParseExact(date, "HH:mm dd/MM/yyyy", null, DateTimeStyles.None, out DateTime dOutDate))
                {
                    return dOutDate;
                }
                else
        ...
        public static string ToDateTimeExactString(this DateTime date)
        {
        ...
        {
            return date?.ToString("dd-MM-yyyy_HH_mm");
        }
        public static string ToFileNameString(this DateTime date)
        {
            return date.ToString("dd-MM-yyyy_HH_mm");
        ...
        public static string ToVNString2(this DateTime date)
        {
            return date.ToString("dd/MM/yyyy HH:mm");
        }

        public static string ToVNTimeString(this DateTime date)
        {
        ...
        public static string FormatThousand(this decimal f)
        {
            if (f == 0) return "0";
            return f.ToString("#,##0.####", CultureInfo.CreateSpecificCulture("en-US"));
        }

        public static string FormatThousand(this float f)
        {
            if (f == 0) return "0";
            return Convert.ToDecimal(f).ToString("#,##0.####", CultureInfo.CreateSpecificCulture("en-US"));
        }

        public static string FormatThousand(this int f)
        {
            if (f == 0) return "0";
            return f.ToString("#,##0", CultureInfo.CreateSpecificCulture("en-US"));
        }

        public static float Round(this float f, int roundNumber = 2)
        {
            return MathF.Round(f, roundNumber);
        }
    }
}
